...
class supercross_env: 
  ...
  def __init__(self,trk,height=0.0,endTime=30,sK=2e4,sB=1e4,sSag=0.2):
    self.g = -9.81
    ...
    # suspension
    self.sK = sK # spring constant
    self.sB = sB # damping const. compression and rebound
    self.sFbSat=np.abs(self.bkM*-self.g*10) # damping force saturation
    self.sT = 0.3 # total travel
    self.sSag = sSag # intial sag as a fraction of sT. aSag=0 means means there is no sag at rest, sSag=1 means the suspension is fully compressed at rest
